...
public class BedrockService {
    ...
    public String analyzeMedicineText(String rawText) {
        String prompt = """
                당신은 복약 지도 전문 AI입니다. 모든 설명은 의학 전공자가 아닌 일반 성인이 자연스럽게 이해할 수 있는 말로 작성해주세요.
                전문 용어는 쉬운 말로 풀어쓰되 유아적이거나 지나치게 단순한 표현은 피하고, 간결하고 명확하게 설명해주세요.
                ...
                {
                  "medicineName": "약 이름",
                  "simpleDescription": "이 약의 용도를 일반인이 이해하기 쉽게 한 줄로 설명 (예: 위 점막을 손상시키는 균을 억제해 위궤양을 치료하는 약입니다)",
                  "ingredients": [{ "name": "성분명", "amount": "용량", "effect": "전문 용어 없이 풀어쓴 주요 효능 (예: 위장 근육의 과도한 수축을 완화해 복통을 줄여줍니다)" }],
                  "dosage": {
                    "perDose": "1회 복용량",
                    "frequency": "하루 복용 횟수",
